    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div
            ...
            <div>
                ...
                <form method="POST" action="/dashboard/pergub" enctype="multipart/form-data">
                    @csrf
                    <div class="mt-4">
...
<div x-show="$store.modal.editModal" x-transition:enter="transition ease-out.duration-300"
    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div
            class="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full sm:p-6">
            <form method="POST" x-ref="editForm" :action="'/dashboard/pergub/' + $store.modal.editPerda.id"
                enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">Edit Data Peraturan Gubernur
                </h3>
                <div class="mt-2">
                    <p class="text-sm text-gray-500">Perbarui form di bawah untuk memodifikasi data yang ada.</p>
                </div>
                <div class="mt-4">
                    <label class="block font-medium text-gray-700">Produk Hukum</label>
    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div
            ...
            <div>
                ...
                <form method="POST" action="{{ route('pergub.import') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="mt-4">
