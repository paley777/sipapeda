    ...
    <ol class="flex leading-none">
        <li>
            ...
            <a href="/dashboard/berita"
                class="{{ request()->is('dashboard/berita') ? 'bg-indigo-600 text-white' : 'bg-gray-200 text-gray-700' }} py-1 px-3 rounded-full hover:bg-indigo-700 transition-colors duration-150 ease-in-out mr-1">
                /berita
            </a>
